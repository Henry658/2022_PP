...
void workerThreadStart(WorkerArgs *const args)
{
    ...
    // int start = args->threadId * block_size;
    // block_size += (args->threadId + 1 == args->numThreads) ? args->height % args->numThreads : 0;
    // mandelbrotSerial(args->x0, args->y0, args->x1, args->y1, args->width, args->height, start, block_size, args->maxIterations, args->output);

    int N = args->height;
    int start = args->threadId;
